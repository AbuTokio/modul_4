...
-- Dann kommen in Klammern die Spaltennamen und deren Datentypen.
CREATE TABLE
    Students (
        -- SERIAL - Spalte die automatisch beim Einfügen von Daten hochgezählt wird.
        -- PRIMARY KEY - Spalte mit eindeutigen Werten, die einen Datensatz identifiziert.
        -- VARCHAR - Variable Character, also eine Zeichenkette (string).
        -- VARCHAR(n) - n ist die maximale Länge der Zeichenkette.
    ...
    -- Datensätze fügen wir mit INSERT INTO Tabellenname ein.
    -- Danach kommen in Klammern die Spaltennamen, in die wir Werte einfügen wollen.
    -- StudentID lassen wir weg, da diese Spalte automatisch hochgezählt wird.
    -- Danach kommt VALUES mit den Werten in der gleichen Reihenfolge wie die Spaltennamen.
INSERT INTO
    Students (
        FirstName,
        LastName,
